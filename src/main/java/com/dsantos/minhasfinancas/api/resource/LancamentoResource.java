...
public class LancamentoResource {
	...
	public ResponseEntity buscar(
			//@RequestParam java.util.Map<String, String> params "Assim passaria um mapa de Params com chave que seria a variavel é o valor que seria  o valor do params."
		...
		if(!usuario.isPresent()) {
			return ResponseEntity.badRequest().body("Não foi possivel realziar a consulta. Usuario não encotnrado para o Id informado.");
		}else {
